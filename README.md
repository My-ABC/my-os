...
- **Keyboard** — IRQ1, scancode set 1 (including the numeric keypad and `0xE0` extended codes), 32-byte ring buffer
...
make test-keyboard  # keyboard: 'b' -> blue screen, other keys -> halt
```
